        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {myProducts.map((item, i) => (
            <div key={i} className="flex flex-col items-center group text-center">
              <div className="w-full aspect-square border border-slate-100 p-8 flex items-center justify-center bg-white shadow-sm hover:shadow-xl hover:border-blue-100 transition-all rounded-3xl">
      ...
      <section id="iletisim" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16">
           <div className="space-y-8">
              <h3 className="text-4xl font-black text-slate-900 uppercase italic border-l-8 border-blue-600 pl-6">Bizimle İletişime Geçin</h3>
              ...
              <div className="space-y-4">
                 <div className="flex items-center space-x-4">
                    ...
                    <span className="font-bold text-slate-700">Hacıeyüplü, 3213 Sk No:7, Merkezefendi/Denizli</span>
                 </div>
                 <div className="flex items-center space-x-4">
                    <span className="text-3xl">📞</span>
                    <a href={`tel:${phoneNumber}`} className="text-2xl font-black text-blue-600">{displayPhone}</a>
                 </div>
              </div>
           </div>
           <div className="bg-slate-50 p-10 rounded-3xl border border-slate-200 shadow-sm">
              <form action="mailto:manasboya20@gmail.com" method="post" encType="text/plain" className="space-y-4">
                ...
                <button className="w-full bg-blue-600 text-white font-black py-4 rounded-xl hover:bg-slate-900 transition shadow-lg uppercase tracking-widest">Mesajı Gönder</button>
              </form>
           </div>
        </div>
      </section>
